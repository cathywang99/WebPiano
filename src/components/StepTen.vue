<template>
  <div class="StepFirst" ref="piano">
    ...
    <div class="guide">
      ...
      <p class="title">根据所听到的音频，选择对应的八度</p>
      <div>
        <img @click="startStep" src="../assets/StepNine/trumpet.png" />
      </div>
      <div class="select">
        <span class="ul" @click="getMyKey(4)">低音3</span>
        <span class="ul" @click="getMyKey(16)">低音2</span>
        <span class="ul" @click="getMyKey(28)">低音1</span>
        <span class="ul" @click="getMyKey(40)">中央C</span>
        <span class="ul" @click="getMyKey(52)">高音1</span>
        <span class="ul" @click="getMyKey(64)">高音2</span>
        <span class="ul" @click="getMyKey(76)">高音3</span>
      </div>
    </div>
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    startStep() {
      ...
      console.log("当前的八度是：" + this.tone);
      this.musicUrl = require(`../assets/audio/${
        this.VirtualkeyMap[this.tone]
      }.wav`);
      audio.load();
      audio.play();
    },
